...
from sqlalchemy import DateTime, String, Integer, Enum, Index, ForeignKey
...
class User(Base):
    ...
    username: Mapped[str] = mapped_column(String(50), unique=True, nullable=False, comment="用户名称")
    password: Mapped[str] = mapped_column(String(255), nullable=False, comment="密码")
    nickname: Mapped[Optional[str]] = mapped_column(String(50), nullable= False, comment="昵称")
    avatar: Mapped[Optional[str]] = mapped_column(String(255), comment="头像", default='https://fastly.jsdelivr.net/npm/@vant/assets/cat.jpeg')
