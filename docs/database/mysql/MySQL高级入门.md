...
![image-20230616161724113](MySQL%E5%85%A5%E9%97%A8.assets/image-20230616161724113.png)
...
1、编辑MySQL配置文件：打开MySQL的配置文件，linux docker位置在`/var/lib/docker/volumes/mysql8_conf/_data`下，通常是my.cnf（Linux）或my.ini（Windows）。可以使用文本编辑器打开该文件。
...
2. 删除数据目录，即删除 /var/lib/docker/volumes/mysql8_data/_data 目录下数据
3. 在MySQL配置文件（/var/lib/docker/volumes/mysql8_conf/_data/my.cnf ）的 [mysqld] 中添加 lower_case_table_names=1 
```
...
```shell
vim /var/lib/docker/volumes/mysql8_conf/_data/my.cnf
```
...
![image-20260603145640666](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603145640666.png)
...
![image-20260603145808858](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603145808858.png)
...
![image-20230617153844435](MySQL%E5%85%A5%E9%97%A8.assets/image-20230617153844435.png)
...
![image-20230617162853812](MySQL%E5%85%A5%E9%97%A8.assets/image-20230617162853812.png)
...
![image-20230617164347933](MySQL%E5%85%A5%E9%97%A8.assets/image-20230617164347933.png) 
...
SELECT * FROM testdb.employee WHERE id = 5; 
```
...
![image-20230625215627766](MySQL%E5%85%A5%E9%97%A8.assets/image-20230625215627766.png) 
...
![1695027084044](MySQL%E5%85%A5%E9%97%A8.assets/1695027084044.png)

2、第二次执行相同的SQL：

![1695027118323](MySQL%E5%85%A5%E9%97%A8.assets/1695027118323.png)
...
![image-20260603160919523](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603160919523.png)
...
![image-20260603161018420](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603161018420.png)
...
![image-20260603161923484](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603161923484.png)
...
![image-20260603162357552](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603162357552.png)

存在外键约束，不能进行删除，更新主表country表的字段 country_id : 
...
![image-20260603162504001](MySQL%E5%85%A5%E9%97%A8.assets/image-20260603162504001.png)
...
![1551347590309](MySQL%E5%85%A5%E9%97%A8.assets/1551347590309.png) 
...
![1555902055367](MySQL%E5%85%A5%E9%97%A8.assets/1555902055367.png) 
...
```sql
-- 将tb_sku*.sql脚本到linux服务器中, /var/lib/docker/volumes/mysql8_data/_data/sku_sql
...
![image-20230618094239826](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618094239826.png) 
...
![image-20230618094404240](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618094404240.png) 
...
![image-20230618094844386](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618094844386.png) 
...
![image-20230618095053363](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618095053363.png) 
...
![image-20230618095515772](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618095515772.png)  

为了提高查询效率，就需要 减少磁盘IO数 。**为了减少磁盘IO的次数，就需要尽量降低树的高度**，需要把原来“瘦高”的树结构变的“矮胖”，树的每层的分叉越多越好。针对同样的数据，如果我们把二叉树改成 三叉树：

![image-20230618095453756](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618095453756.png) 
...
![image-20230618100719352](MySQL%E5%85%A5%E9%97%A8.assets/image-20230618100719352.png) 
...
![image-20230619113702712](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619113702712.png) 
...
![image-20230619113911410](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619113911410.png) 

把一些记录放到**页**里的示意图就是【**数据都是存储到数据页中，一个数据页占用一个磁盘块**】：

![image-20230619114041208](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619114041208.png) 
...
![image-20230619114900237](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619114900237.png) 
...
![image-20230619124557527](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619124557527.png)  
...
![image-20230619124531531](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619124531531.png) 
...
![image-20230619124928306](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619124928306.png) 
...
![image-20230619140453439](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619140453439.png) 
...
![image-20230619141412346](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619141412346.png) 
...
![image-20230619141543955](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619141543955.png) 
...
![image-20230619142014166](MySQL%E5%85%A5%E9%97%A8.assets/image-20230619142014166.png) 
...
![1695056507955](MySQL%E5%85%A5%E9%97%A8.assets/1695056507955.png)

如果我们在Col2上建立一个二级索引，则此索引的结构如下图所示**（是非聚簇索引）**：

![1695056531776](MySQL%E5%85%A5%E9%97%A8.assets/1695056531776.png) 
...
![1695056622789](MySQL%E5%85%A5%E9%97%A8.assets/1695056622789.png) 
