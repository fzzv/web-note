...
- ##### static内存图解
  ...
  ![image-20210330233224326](%E5%85%B3%E9%94%AE%E5%AD%97&%E6%8E%A5%E5%8F%A3&%E4%BB%A3%E7%A0%81%E5%9D%97&%E6%9E%9A%E4%B8%BE.assets/image-20210330233224326.png)
...
- public -- protected -- 默认的 -- private
  ...
  ![image-20210331215542736](%E5%85%B3%E9%94%AE%E5%AD%97&%E6%8E%A5%E5%8F%A3&%E4%BB%A3%E7%A0%81%E5%9D%97&%E6%9E%9A%E4%B8%BE.assets/image-20210331215542736.png)

  ```java
  package com.fan.permissions_demo1;
  ...
  ```java
  package com.fan.permissions_demo2;
  
  import com.fan.permissions_demo1.Fu;
...
- 作用 : 一般用于给静态成员初始化
  ...
  ```java
  package com.fan.code_block.static_demo;
  /*
    静态代码块 :
...
- 控制变量的局部变量的声明周期
  ...
  ```java
package com.fan.code_block.local_demo;
/*
    局部代码块 :
...
```java
package com.fan.interface_demo;
...
```java
package com.fan.interface_demo.interface_test;
